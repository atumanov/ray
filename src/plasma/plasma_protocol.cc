...
protocol_builder *make_protocol_builder(void) {
  flatbuffers::FlatBufferBuilder *fbbptr = new flatbuffers::FlatBufferBuilder();
  return fbbptr;
}
...
int SendClearBuffer(protocol_builder *fbb, int sock, int message_type) {
  int rv = write_message(sock, message_type, fbb->GetSize(), fbb->GetBufferPointer());
  fbb->Clear();
  return rv;
}
...
int plasma_send_CreateRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaCreateRequest);
}
...
int plasma_send_CreateReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaCreateReply);
}
...
int plasma_send_SealRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaSealRequest);
}
...
int plasma_send_SealReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaSealReply);
...
int plasma_send_ReleaseRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaReleaseRequest);
}
...
int plasma_send_ReleaseReply(int sock,
  ...
  auto message = CreatePlasmaReleaseReply(*fbb, to_flat(*fbb, object_id),
                                          (PlasmaError) error);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaReleaseReply);
...
int plasma_send_DeleteRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaDeleteRequest);
...
int plasma_send_DeleteReply(int sock,
  ...
  auto message = CreatePlasmaDeleteReply(*fbb, to_flat(*fbb, object_id),
                                         (PlasmaError) error);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaDeleteReply);
...
int plasma_send_StatusRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaStatusRequest);
...
int plasma_send_StatusReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaStatusReply);
...
int plasma_send_ContainsRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaContainsRequest);
...
int plasma_send_ContainsReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaContainsReply);
...
int plasma_send_ConnectRequest(int sock, protocol_builder *fbb) {

  auto message = CreatePlasmaConnectRequest(*fbb);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaConnectRequest);
...
int plasma_send_ConnectReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaConnectReply);
...
int plasma_send_EvictRequest(int sock, protocol_builder *fbb, int64_t num_bytes) {

  auto message = CreatePlasmaEvictRequest(*fbb, num_bytes);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaEvictRequest);
...
int plasma_send_EvictReply(int sock, protocol_builder *fbb, int64_t num_bytes) {

  auto message = CreatePlasmaEvictReply(*fbb, num_bytes);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaEvictReply);
...
int plasma_send_GetRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaGetRequest);
...
int plasma_send_GetReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaGetReply);
...
int plasma_send_FetchRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaFetchRequest);
...
int plasma_send_WaitRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaWaitRequest);
...
int plasma_send_WaitReply(int sock,
  ...
  auto message = CreatePlasmaWaitReply(
      *fbb, fbb->CreateVector(object_replies.data(), num_ready_objects),
      num_ready_objects);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaWaitReply);
...
int plasma_send_SubscribeRequest(int sock, protocol_builder *fbb) {

  auto message = CreatePlasmaSubscribeRequest(*fbb);
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaSubscribeRequest);
...
int plasma_send_DataRequest(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaDataRequest);
...
int plasma_send_DataReply(int sock,
  ...
  fbb->Finish(message);
  return SendClearBuffer(fbb, sock, MessageType_PlasmaDataReply);
